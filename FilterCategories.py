...
# Sourced From https://github.com/immersive-limit/coco-manager
# This is used to filter a specific category or categories that might be needed for the project
